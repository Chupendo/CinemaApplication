package com.tokioschool.filmweb.configs.interceptors;
...
public class LoggerConfiguration implements WebMvcConfigurer {
    ...
    public HandlerInterceptor handlerInterceptor() {
        return new HandlerInterceptor() {
            ...
            /**
             * Filtra las peticiones que comienzan con "/web".
             *
             * @param request la solicitud HTTP.
             * @return true si la URI comienza con "/web", de lo contrario false.
             */
